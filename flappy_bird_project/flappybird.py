...
BG_IMG = pygame.transform.scale2x(pygame.image.load(os.path.join("imgs", "ba.png")))

# set bird images
NSHAN_BIRD = [pygame.transform.scale2x(pygame.image.load(os.path.join("imgs", "lakers_bird.png"))), pygame.transform.scale2x(pygame.image.load(os.path.join("imgs", "lakers_bird.png"))), pygame.transform.scale2x(pygame.image.load(os.path.join("imgs", "lakers_bird.png")))]
...
BIRD_IMGS = NSHAN_BIRD

FLAPPY_BIRD_FONT = pygame.font.Font(os.path.join("fonts", "flappybirdy", "FlappyBirdy.ttf"), 100)
...
JUMP_EFFECT = pygame.mixer.Sound(os.path.join("music", "geo_dash.wav"))
...
def draw_main_gui(*argv):
    ...
    title = FLAPPY_BIRD_FONT.render("Flappy Bird", 1, (0,244,0))
    subtitle = FLAPPY_BIRD_FONT_SMALL.render("with AI", 1, (0,244,0))
...
def run_settings_gui():
    ...
    # create title with flappy bird font
    title = FLAPPY_BIRD_FONT.render("Skins", 1, (0,244,0))
    ...
    nshan_button = Button((200, 235, 107), 25, buttonX, buttonY, button_width, 60, "Nshan's Skin")
    alvin_button = Button((200, 235, 107), 25, buttonX, buttonY + button_gap, button_width, 60, "Alvin's Skin")
    gregory_button = Button((200, 235, 107), 25, buttonX, buttonY + 2 * button_gap, button_width, 60, "Gregory's Skin")
    lillian_button  = Button((200, 235, 107), 25, buttonX, buttonY + 3 * button_gap, button_width, 60, "Lillian's Skin")

    nshan_button.draw(win)
...
def run_gui(): 
    ...
    noAI_button = Button((200, 235, 107), 25, centerX - (button_width/2), buttonY, button_width, 60, "Manual Play")
    trainAI_button = Button((200, 235, 107), 25, centerX - (button_width/2), buttonY + button_gap, button_width, 60, "Train AI")
    bestAI_button = Button((200, 235, 107), 25, centerX - (button_width/2), buttonY + 2 * button_gap, button_width, 60, "Run best AI")
    settings_button = Button((200, 235, 107), 25, centerX - (button_width/2), buttonY + 3 * button_gap, button_width, 60, "Skins")
